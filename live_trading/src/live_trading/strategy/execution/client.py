    ...
    async def poll_resting_orders(self) -> list[RestingOrderUpdate]:
        ...
        async with self._resting_lock:
            ...
            for order_id, ro in list(self._resting.items()):
                ...
                if self.mutate_books:
                    # Replay-only mode can consume its private synthetic book.
                    # Paper mode leaves the public market-data snapshot untouched.
