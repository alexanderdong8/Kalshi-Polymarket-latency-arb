> **Source note:** The content below was moved directly from
> `trade_system/README.md`. It documents the original Trade System project.
> Current application architecture and implementation status are documented
